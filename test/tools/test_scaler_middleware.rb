...
class ScalerToolTest < Test::Unit::TestCase
  
  def test_action_description
    assert_equal "Scale the comp by a specified factor", Tracksperanto::Tool::Scaler.action_description
  end
  
  def test_default_factor_set_to_one
    receiver = flexmock
    m = Tracksperanto::Tool::Scaler.new(receiver)
  ...
  def test_scaler_supports_hash_init
    receiver = flexmock
    m = Tracksperanto::Tool::Scaler.new(receiver, :x_factor => 1.2)
  ...
  def test_scaler_bypasses_methods
    ...
    m = Tracksperanto::Tool::Scaler.new(receiver, :x_factor => 2, :y_factor => 3)
  ...
  def test_flip_using_scaler
    ...
    m = Tracksperanto::Tool::Scaler.new(receiver, :x_factor => -1, :y_factor => -1)
  ...
  def test_scaler_properly_affects_residual
    ...
    m = Tracksperanto::Tool::Scaler.new(receiver, :x_factor => 1.5, :y_factor => 1.4)
    m.start_export(50, 60)
    m.start_tracker_segment("Tracker")
